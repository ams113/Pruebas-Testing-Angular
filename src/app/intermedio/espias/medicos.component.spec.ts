...
describe('MedicosComponent', () => {
    ...
    it('Debe de llamar al servidor para agregar un médico', () => {
        ...
        const mock = spyOn(servicio, 'agregarMedico').and.callFake( medico => {
    ...
    it('Si falla la agregación, la propiedad mensajeError debede ser iugal al error del servicio', () => {
        const miError = 'No se puedo aggregar el médico';
    ...
    it('Debe de llamar al servidor para borrar un médico', () => {
        ...
        const stub = spyOn(servicio, 'borrarMedico').and.returnValue( medico => {
            return Observable.empty();
        });
    ...
    it('NO Debe de llamar al servidor para borrar un médico', () => {
        ...
        expect( stub ).not.toHaveBeenCalledWith('1');
    });
